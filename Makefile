...
MXNET_DIR := /home/elegantgod/work/incubator-mxnet
MXNET_INCLUDE_DIR := $(MXNET_DIR)/include
MXNET_DMLC_INCLUDE_DIR :=$(MXNET_DIR)/3rdparty/dmlc-core/include
MXNET_CPP_INCLUDE_DIR := $(MXNET_DIR)/cpp-package/include
MXNET_NNVM_INCLUDE_DIR := $(MXNET_DIR)/3rdparty/nnvm/include
MXNET_LIB_DIR := $(MXNET_DIR)/lib
...
INCLUDE_DIRS := $(MXNET_INCLUDE_DIR) $(MXNET_DMLC_INCLUDE_DIR) $(MXNET_CPP_INCLUDE_DIR) $(MXNET_NNVM_INCLUDE_DIR) $(INCLUDE_DIR) $(CUDA_INCLUDE_DIR) $(OPENCV_INCLUDE_DIR) $(EIGEN_INCLUDE_DIR)
LIBRARY_DIRS := $(MXNET_LIB_DIR) $(LIB_DIR) $(OPENCV_LIB_DIR) $(GLOG_LIB_DIR) $(CUDA_DIR)/lib64
LIBRARIES := mxnet boost_system opencv_videoio opencv_imgcodecs opencv_core opencv_imgproc opencv_highgui glog cudart cublas curand
